...
- [onMount](lifecycle-hooks.html#onMount)
- [onDestroy](lifecycle-hooks.html#onDestroy)
- [tick](lifecycle-hooks.html#tick)
- [Deprecated: beforeUpdate / afterUpdate](lifecycle-hooks.html#Deprecated:-beforeUpdate-afterUpdate)
...
### Chat window example[](lifecycle-hooks.html#Deprecated:-beforeUpdate-afterUpdate-Chat-window-example)
...
[Edit this page on GitHub](https://github.com/sveltejs/svelte/edit/main/documentation/docs/06-runtime/03-lifecycle-hooks.md)

previous next

[Context](context.html) [Imperative component API](imperative-component-api.html)
