...
[Edit this page on GitHub](https://github.com/sveltejs/svelte/edit/main/documentation/docs/05-special-elements/06-svelte-element.md)

previous next

[<svelte:head>](svelte-head.html) [<svelte:options>](svelte-options.html)