...
[Edit this page on GitHub](https://github.com/sveltejs/svelte/edit/main/documentation/docs/05-special-elements/02-svelte-window.md)

previous next

[<svelte:boundary>](svelte-boundary.html) [<svelte:document>](svelte-document.html)