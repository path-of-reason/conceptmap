...
In runes mode, reactive state is explicitly declared with the [`$state` rune]($state.html).
...
[Edit this page on GitHub](https://github.com/sveltejs/svelte/edit/main/documentation/docs/99-legacy/01-legacy-let.md)

previous next

[Overview](legacy-overview.html) [Reactive $: statements](legacy-reactive-assignments.html)